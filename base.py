...
target_list = ['https://www.ss.com/lv/real-estate/homes-summer-residences/talsi-and-reg/all/sell/',
               'https://www.ss.com/lv/real-estate/homes-summer-residences/tukums-and-reg/sell/',
               'https://www.ss.com/lv/real-estate/homes-summer-residences/valmiera-and-reg/sell/',
               'https://www.ss.com/lv/real-estate/homes-summer-residences/cesis-and-reg/sell/',
               'https://www.ss.com/lv/real-estate/homes-summer-residences/kuldiga-and-reg/sell/']
google_filename = "SS"
...
def get_unique(worksheet):
    ...
    date_list = [itemx for itemx in worksheet.col_values(4) if itemx]
